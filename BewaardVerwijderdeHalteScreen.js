...
const BewaardVerwijderdeHalteScreen = props => {
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {'Beginlocatie: Metrostation Noord'}
          </Text>
          {/* Text 2 */}
          <Text
            accessible={true}
          ...
          >
            {'Eindlocatie: Metrostation Weesperplein'}
          </Text>
          {/* Button 2 */}
          <Button
            accessible={true}
            ...
            title={'Plan een reis op dit traject'}
          />
          <Button
            accessible={true}
            iconPosition={'left'}
            onPress={() => {
              try {
                navigation.navigate('BewaardVerwijderdeRouteScreen');
              } catch (err) {
                console.error(err);
              }
            }}
        ...
        >
          {
            'Je hebt nog geen bewaarde haltes. Voeg hieronder een nieuwe halte toe'
          }
        </Text>
        <Button
          accessible={true}
...
export default withTheme(BewaardVerwijderdeHalteScreen);
